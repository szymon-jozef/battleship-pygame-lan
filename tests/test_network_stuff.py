...
def test_building_payloads_attack():
...
def test_building_payloads_shot_result():
...
def test_building_payloads_ready():
...
def test_building_payloads_start():
...
def test_building_payloads_end():
...
def test_building_payloads_game_over():
